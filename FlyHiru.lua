local Script_Title = "Hiru Hub <font color=\"rgb(255, 0, 0)\">|</font> Fly Gui V2"
local Hiru = Instance.new("ScreenGui")
...
Hiru.Name = "Hiru"
Hiru.Enabled = true
Hiru.ResetOnSpawn = true
Hiru.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Hiru.DisplayOrder = 999999999
Main.Name = "Main"
Main.Parent = Hiru
Main.Active = true
Main.Draggable = true
...
Logo.ZIndex = 2
Logo.Image = "http://www.roblox.com/asset/?id=74417138713617"
...
local success, err = pcall(function()
	Hiru.Parent = uiparent()
end)
if not success then
	Hiru.Parent = game:GetService("Players").LocalPlayer.PlayerGui
end
...
local incraseBtn
incraseBtn = addButton("More Speed", function()
	local char = speaker.Character
...
local decraseBtn
decraseBtn = addButton("Slow Down", function()
	local char = speaker.Character
	if char and char.Humanoid then
		local hum = char.Humanoid
		if speeds > 1 then
